...
const files = self.__WB_MANIFEST; // file matching globDirectory and globPattern in rollup.config.js
...
setCatchHandler(async ({ event }) => {
  switch (event.request.destination) {
    case 'document':
      return matchPrecache(entrypointUrl);
    case 'image':
      return matchPrecache(fallbackImage);
    default:
